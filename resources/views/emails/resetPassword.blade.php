...
<p style="font-size: 24px; line-height: 1.2; text-align: center; mso-line-height-alt: 29px; margin: 0;"><span style="font-size: 24px;">{{ trans('frontend.reset_pass') }}</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<p style="font-size: 16px; line-height: 1.5; text-align: center; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;"><strong><span style="font-size: 19px;">{{ trans('frontend.dear_client', ['type' => strtolower(trans('frontend.'.$data['profile_type']))]) }}</span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div style=" font-size: 12px; line-height: 1.5; color: #283C4B; mso-line-height-alt: 18px;">
<p style="font-size: 17px; line-height: 1.5; text-align: center; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 18px;">{{ trans('frontend.reset_pass_txt') }}</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.2; text-align: center; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 14px;"><a href="{{ route('auth.newPasswordForm', ['code' => $data['code'], 'id' => $data['user_id']]) }}" rel="noopener" style="color: #3AAEE0;" target="_blank">{{ route('auth.resetPasswordForm', ['code' => $data['code'], 'id' => $data['user_id']]) }}</a></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 20px; padding-left: 20px; padding-top: 20px; padding-bottom: 30px; font-family: Arial, sans-serif"><![endif]-->
