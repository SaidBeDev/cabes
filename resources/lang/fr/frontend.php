...
return [
    ...
    'available_table' => "Table de disponibilité",
    'teacher_hrs' => "Heures enseignées",
    'studied_hrs' => "Heures étudiées",
    'credits' => "Credits",
    'date' => "La Date",
    'capacity' => "Capacité",
    'hour_from' => "De l'heure",
